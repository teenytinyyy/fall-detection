        ...
        ##print("frame_height = ", frame_height)
                ...
                if len(predictions[0]["pred_masks"]) != 0:
                    ...
                    if flag_checkpoint == True:
                        ...
                        box_center_dis = eucliDist((box_center_x[count-video_frame*2] / frame_width, box_center_y[count-video_frame*2] / frame_height), (box_center_x[count] / frame_width, box_center_y[count] / frame_height))
                        ...
                        if (b+1) % video_frame == 0:
                            last_5_box_r = (bbox_r[count] + bbox_r[count-1] + bbox_r[count-2] + bbox_r[count-3] + bbox_r[count-4])/5
                            #last_5_center_dis = (center_dis[0] + center_dis[1] + center_dis[2] + center_dis[3] + center_dis[4])/5
                            last_5_center_dis =(box_center_dis)
                            front_5_frame_r = (bbox_r[count-video_frame*2] + bbox_r[count-video_frame*2+1] + bbox_r[count-video_frame*2+2] + bbox_r[count-video_frame*2+3] + bbox_r[count-video_frame*2+4])/5
