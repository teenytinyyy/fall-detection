...
for num1 in range(1, 2):
    ...
    video_frame = 8
    imagePath = "../dataset/data/coffee(4)010.jpg"
    #class_name = "fall"
    ...
    if h_thresh:
        ...
        test_bool = "false"
    output_path = '../dataset/data/Diff/motion_9_diff/bbox_' + video_name + "/"
    ...
    if __name__ == '__main__':
        ...
        imageData = create_json.img_data(imagePath)
        ...
        for idx, frame in enumerate(images):
            ...
            create_json.create_json_file(polygons, imagePath, imageData, frame_height, frame_width, frame)
