                ...
                while True:
                    ...
                    if 2 > abs(ar[frame_idx] - ar[frame_idx + 4]) >= threshold:
                        ...
                        if (len(avg_list[frame_idx - radius: frame_idx + radius]) == radius * 2 and len(ar[frame_idx - radius: frame_idx + radius]) == radius * 2):
                            split_points.append((num, num1, frame_num[frame_idx - radius], frame_num[frame_idx + radius]))
                            frame_idx += radius
                        frame_idx += 1
                        continue
                    ...
                    frame_idx += 1
    np.savetxt("../dataset/data/excel/mask_rcnn_1286/1286targets_0.55.csv", np.c_[split_points], delimiter=",")
